...
class HttpApplicationUserSyncClientTest {
    ...
    void setUp() throws IOException {
        ...
        server.createContext("/account-sso/internal/users/upsert", new CapturingHandler(200));
        server.createContext("/account-sso/internal/users/disable", new CapturingHandler(200));
    ...
    void upsertSendsSignedRequestWithCorrectHeaders() throws Exception {
        ...
        HttpApplicationUserSyncClient client = new HttpApplicationUserSyncClient(signatureService);
        ...
        ApplicationSyncRequest syncRequest = mapper.readValue(capturedBody.get(), ApplicationSyncRequest.class);
        assertThat(syncRequest.getAppCode()).isEqualTo("cms-ai");
        assertThat(syncRequest.getAccount()).isEqualTo("zhangsan");
        assertThat(syncRequest.isEnabled()).isTrue();
    }
    ...
    void disableSendsSignedDisableRequest() throws Exception {
        ...
        ObjectMapper mapper = new ObjectMapper();
        ApplicationSyncRequest syncRequest = mapper.readValue(capturedBody.get(), ApplicationSyncRequest.class);
        assertThat(syncRequest.isEnabled()).isFalse();
    }
